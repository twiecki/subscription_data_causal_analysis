...
| k-099a | canonical | Governed metric: `signups` = daily gross new free registrations; inflow term of the pool identity | 1-data/semantic-layer/signups.yml | governed definition, v0.1.0 | fe335d5e45bb |
| i-c64a | active | The price hike produced no detectable change in signup inflow: -1.6%, placebo-calibrated 95% CI [-4.9, +1.8]; bounded at +/-4.8% MDE | 2-analyses/signups-inflow/memo.md | validated null: placebo-in-time z=-1.21 over 12 fake dates (p=0.25), ROPE +/-5% P=0.978, Poisson agrees -1.5% | 9f4799817be8 |

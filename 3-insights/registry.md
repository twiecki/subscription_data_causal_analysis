...
| k-1231 | canonical | DiD/synthetic control unidentifiable for the price hike: data is one aggregate series, zero untreated units — estimand undefined, donor pool empty | 2-analyses/price-hike-did-failure/memo.md | failure.json: candidate_unit_columns=[], DiD design rank 2/4, n_donors=0 | 0cea979f4be4 |
